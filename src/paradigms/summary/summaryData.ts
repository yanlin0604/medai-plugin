...
const homepageConfig: SummaryConfig = {
  form: {
    ...
    contentLabel: '病案首页内容（患者信息、诊断、手术、费用等）',
  },
  historyTitle: '患者全量信息汇总',
  ...
  patients: [
    {
      ...
      points: [
        { tag: 'primary', label: '[患者信息]', text: '已自动汇总患者基本信息、联系人、医保信息。' },
    ...
    patients: [
      {
        ...
        draft: `（AI 已基于 ${p.name} 的全量历史病历自动汇总生成${doc.name}草稿，医生可在此微调后提交。）`,
      },
    ],
  };
}
