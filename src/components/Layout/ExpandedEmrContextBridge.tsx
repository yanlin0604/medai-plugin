...
export default function ExpandedEmrContextBridge() {
  ...
  const setEmrDebug = useBubbleStore((state) => state.setEmrDebug);
  ...
  useEffect(() => {
    ...
    return cleanup;
  }, [location.pathname, markActivated, navigate, selectDoc, selectPatient, setDetectedContext, setEmrDebug]);
